...
prefix = "!"
name = "~ G B O T"
rdaftar = "TERIMA KASIH TELAH DAFTAR MENJADI TEMEN GBOT😁"
rmenu = "HAI TEMEN GBOT👋 JANGAN LUPA DONASI YAA:)"
limitt = 10
ban = []
...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const Iwild Ganz = ["085889758808@s.whatsapp.net"]
			...
			const ownerNumber = ["6385889758808@s.whatsapp.net"]
		...
		case 'daftar':
					...
					if (isUser) return reply('kamu sudah Menjadi Temen GBOT:D')
					if (isBanned) return reply(mess.only.benned)
					user.push(sender)
...
* : @${me.jid.split('@')[0]}\n⟩➢ *prefix* : | ${prefix} |\n⟩➢ *Total Block* : ${blocked.length}\n⟩➢ *Aktif Sejak* : ${kyun(uptime)}\n\n⟩➢ Total Pengguna: *${user.length}* User\n⟩➢ *Instagram* : rehangtps12\n⟩➢ *Special Thanks To* :\n⟩➢ Allah SWT \n⟩➢ MahankBarBar\n⟩Nurutomo\n⟩Fxc7`
            ...
            break  
                 ...
                 case 'kalkulator':
				   ...
				   if (isLimit(sender)) return reply(limitend(pushname2))
				    ...
				    break 
				case 'owner':
                 client.sendMessage(from, {displayname: "iWild", vcard: vcard}, MessageType.contact, { quoted: mek})
         ...
         case 'lirik':
                ...
                if (!isUser) return reply(mess.only.userB)
                    ...
                    client.sendMessage('6285889758808@s.whatsapp.net', options, text, {quoted: mek})
